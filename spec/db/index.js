...
// '@electron/appStorage' collection key
...
// '@electron/appStorage' value encoding
const collection0_enc = getEncoding('@electron/appStorage/hyperdb#0')

// '@electron/appStorage' reconstruction function
...
// '@electron/appStorage' key reconstruction function
...
function resolveCollection (name) {
  switch (name) {
    case '@electron/appStorage': return collection0
    default: return null
  }
}
